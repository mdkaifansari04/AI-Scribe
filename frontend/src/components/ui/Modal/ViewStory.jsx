...
function Icon(open) {
  return (
    <svg
      ...
      stroke="currentColor"
      className={`${
        open.open ? "rotate-180" : "rotate-360"
...
function ViewStoryModal(props) {
  ...
  const themeColor =
    localStorage.getItem("aiScribeTheme") === "dark" ? "white" : "black";
  ...
  return (
    <>
      <Dialog open={open} handler={handleOpen} size={"xl"}>
        <div className="flex items-center justify-between px-3 dark:bg-[#1E293B] ">
          {/* <DialogHeader className="text-black border-none text-center dark:text-[#bfc9d3]">
            Story
          </DialogHeader> */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <DialogBody
          className="h-[50rem] overflow-scroll border-none dark:bg-[#1E293B]"
          divider
        >
          <div className="py-3 lg:px-32">
            <Input
              ...
              name="storyName"
              id="storyName"
              className="py-2 text-xl font-semibold dark:text-[#bfc9d3]"
              variant="static"
              required
              ...
              <AccordionBody>
                <div className="prompts">
                  <div className="p-4 flex gap-2 dark:text-[#bfc9d3]">
                    ...
                    <strong className="dark:text-[#bfc9d3] ">
                      {prompt.story}
                    </strong>
                  </div>
                  <div className="p-4 flex gap-2 dark:text-[#bfc9d3]">
                  ...
                  <div className="p-4 flex gap-2 dark:text-[#bfc9d3]">
                    <p className="font-bold dark:text-[#bfc9d3]">
                      Humor Level:
                    </p>
                    <strong className="dark:text-[#bfc9d3]">
                      {prompt.humor}
        ...
        <DialogFooter className="space-x-2 border-none outline-none dark:bg-[#3A444E]">
          {option === "view" ? (
            <Button
              ...
              size="sm"
              className="green-btn rounded-md btn-green-shadow bg-[#0ABF8C]"
            >
              Share
            </Button>
          ) : (
            <>
              ...
              >
                {loading ? (
                  <Spinner className="h-3 w-3 mx-3 my-0.5" />
                ) : (
                  "Update"
                )}
              </Button>
