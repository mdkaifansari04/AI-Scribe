...
export function ShareModal(props) {
  ...
  return (
    <>
      <div>
        <Dialog
          className="dark:bg-[#3A444E] text-[#AAB8C5]"
          size="xs"
          open={open}
          handler={handleOpen}
          animate={{
              ...
              <ul className="mt-1 -ml-2 flex flex-col gap-1">
                <MenuItem className="flex items-center gap-3 hover:text-red-400">
                  <FacebookShareButton
                    url={url}
                    hashtag="#ai-scribe"
                    quote="AI Scribe - Generated Story"
                    className="flex justify-around gap-5"
                  >
                    <FacebookIcon className="w-8 h-8 rounded-full" />
                    <Typography
                      className="dark:text-[#bfc9d3] dark:hover:text-black"
                      color="blue-gray"
                      variant="h6"
                    >
                      Facebook
              ...
              <ul className="mt-1 -ml-2.5 flex flex-col gap-1">
                <MenuItem className="flex items-center gap-3">
                  <PinterestShareButton
                    url={url}
                    media={
                      "https://res.cloudinary.com/dngfmzv2g/image/upload/v1695238647/ai-scribe-low-resolution-logo-color-on-transparent-background_pxx3op.png"
                    }
                ...
                <MenuItem className="flex items-center gap-3 ">
                  <WhatsappShareButton
                    url={url}
                    title={description}
                    separator="... -generated from AI Scribe (A story generator web app). visit - "
                    className="flex justify-around gap-5"
                  >
