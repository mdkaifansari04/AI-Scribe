...
function GeneratedStory() {
  ...
  return (
    <div className="generated-story my-6 rounded-md">
      {generatedStory && (
        <div className="story mx-5 bg-green-100 dark:bg-teal-50 p-5 px-10 rounded-md">
          ...
          <div className="flex justify-between my-6 dark:text-[#0b1b2b]">
            ...
            <Tooltip
              className="text-white bg-[#232222] dark:bg-white dark:text-[#232222]"
              content="Copy"
              animate={{
                mount: { scale: 1, y: 0 },
            ...
            >
              <ClipboardDocumentListIcon
                ...
                className="w-7 h-7 mx-0 cursor-pointer md:mx-3"
              />
            </Tooltip>
          </div>
          <div className="description dark:text-[#08121d]">
            {generatedStory.story}
          </div>
          <div className="flex justify-between">
            <Tooltip
              className="text-white bg-[#232222] dark:bg-white dark:text-[#232222]"
              content="Rate your story"
              animate={{
                mount: { scale: 1, y: 0 },
                unmount: { scale: 0, y: 25 },
              }}
            ...
            <div className="btn-group my-4 flex gap-4">
              <Button
                ...
                className="bg-[#3aa788]"
              >
                {loading ? <Spinner className="h-3 w-3 mx-1.5 p-0" /> : "Save"}
              </Button>
              <Button
          ...
          {generatedStory.story && (
            <ShareModal
              ...
              description={generatedStory.story.slice(0, 500)}
              open={openShareModal}
      ...
      {loading && (
        <dotlottie-player
          src="https://lottie.host/55a46466-07d1-45c2-a413-b17a62dea343/BIhJOfwc0B.json"
          background="transparent"
          speed="1"
          style={{ width: "200px", height: "200px", margin: "1.5rem auto" }}
          direction="1"
          mode="normal"
          loop
          autoplay
